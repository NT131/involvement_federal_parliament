...
gunicorn_service="/etc/systemd/system/gunicorn_involvement_federal_parliament.service" # /path/to/gunicorn/service
GITHUB_REPO_DIR="/home/nielstack/projects/erpohk/visualisations/involvement_federal_parliament/gunicorn_and_nginx_files/mirrored_files" #"/path/to/local/github/repo"
